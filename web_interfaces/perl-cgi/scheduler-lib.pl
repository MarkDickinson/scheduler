...
# Must be a legal URL path based on your httpd.conf cgi-bin path.
# Note: set in marks_job_scheduler.conf file which the rpm will
# have installed into /etc/httpd/conf.d
...
# The entry added to httpd.conf to identify where scheduler icons are
# Note: set in marks_job_scheduler.conf file which the rpm will
# have installed into /etc/httpd/conf.d
...
# If using /tmp ensire httpd service PrivateTmp is set to false
